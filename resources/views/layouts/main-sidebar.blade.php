				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">الفواتير المدفوع</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">الفواتير الغير مدفوع</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">الفواتير المدفوعة جزئيا
                            </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">ارشيف الفواتير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">التقارير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-sparkline') }}"> تقارير الفواتير  </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-peity') }}">تقارير العملاء  </a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}">قائمةالمستخدمين</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='product-details') }}">صلاحيات المستخدمين</a></li>
						</ul>
					</li>
